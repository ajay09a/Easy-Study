...
# For a server using 0.0.0.0 means to listen on all available interfaces, useful to connect locally
# to 127.0.0.1 and remotely to LAN interface IP
...
def receive_message(client_socket):
    ...
    try:
        ...
        # socket.close() also invokes socket.shutdown(socket.SHUT_RDWR) what sends information about
...
while True:
    ...
    #   - wlist - sockets for data to be send to (checks if for example buffers are not full and socket is
        ...
        # Else existing socket is sending a message
            ...
            for client_socket in clients:
                ...
                if client_socket != notified_socket:
                    ...
                    # We are reusing here message header sent by sender, and saved
                    # username header send by user when he connected
